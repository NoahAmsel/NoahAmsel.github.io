...
\item Contributed to deep learning research on foundation models for scientific data from heterogeneous domains.
...
\item Made race predictions and evaluated wager opportunities by using machine learning methods (Multi-
nomial Logit Model, GAM, Random Forest, PCA) and the Python scientific stack.
\item Analyzed SQL database with 3 million entries and interfaced with RESTful API.
...
\begin{tabular}{lll}
    SIAM-LA & Fixed-Sparsity Matrix Approximation from Matrix-Vector Products & 2024 \\
...
\begin{rSection}{Poster Presentations}
    ...
    \begin{tabular}{lll}
        \specialcell[l]{ICERM \\ASE60 (MIT)\\Mihalis Fest (Columbia)} & Lanczos-FA is Nearly Krylov-Optimal for Rational Functions & 2023 \\
